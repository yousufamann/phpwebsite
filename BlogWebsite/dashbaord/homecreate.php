...
if (isset($_POST['insert'])) {
    ...
    $upload_path = "uploads-homeimages/";

    if (!is_dir($upload_path)) {
        mkdir($upload_path, 0777, true);
    }

    $upload = move_uploaded_file($tmp_image, $upload_path . $image);

    if ($upload) {
        $sql = "INSERT INTO `carousel-data`(`name`, `description`, `image`) VALUES ('$name','$desc','$image')";
        $result = mysqli_query($con, $sql);

       if ($result) {
            echo "<script>alert('home inserted'); window.location.href='home.php';</script>";
        }
         else {
...
<br>
<br>
<h1 style='text-align: center;'>Add Carousel-Data</h1>

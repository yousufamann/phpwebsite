        ...
        <div style="max-width: 600px; margin: 20px auto; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
            <form style="display: flex; flex-direction: column; gap: 15px;" method="post" enctype="multipart/form-data">
                <div style="display: flex; flex-direction: column; gap: 5px;">
                    <label style="font-weight: 500; color: #333;">PostName</label>
                    <input
                        type="text"
                        style="
                    padding: 10px;
                ...
                <div style="display: flex; flex-direction: column; gap: 5px;">
                    <label style="font-weight: 500; color: #333;">PostDescription</label>
                    <input
                        type="text"
                        style="
                    padding: 10px;
                ...
                <div style="display: flex; flex-direction: column; gap: 5px;">
                    <label style="font-weight: 500; color: #333;">PostImage</label>
                    <img src="../dashbaord/uploads-images/<?php echo $q['image']; ?>" height="80px" width="20%">
                    <input
                        type="file"
                        style="
                    padding: 10px;
    ...
    ?>
        ...
        if (isset($_POST['edit'])) {
            ...
            if (move_uploaded_file($tmp_image, "uploads-images/" . $image)) {
                $sql = "UPDATE `post1` SET `name`='$name',`description`='$desc',`image`='$image' WHERE id='$id'";
                $query = mysqli_query($con, $sql);
                if ($query) {
                    echo "<script>alert('post edit'); window.location.href='post.php';</script>";
                } else {
                    echo 'no edit';
                }
            }

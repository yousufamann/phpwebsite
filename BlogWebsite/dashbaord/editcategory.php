...
$id=$_GET['id'];
$sql=mysqli_query($con,"SELECT * FROM category WHERE catid='$id'");
    ...
    <form style="display: flex; flex-direction: column; gap: 15px;" method="Post">
        <div style="display: flex; flex-direction: column; gap: 5px;">
            ...
            <input
                ...
                name="catname" value="<?php echo $row['catname'];?>" required>
        </div>
...
$query=mysqli_query($con,"UPDATE `category` SET `catname`='$name' WHERE catid='$id'");
if($query){
     echo "<script>alert('category edit'); window.location.href='category.php';</script>";
}
else{
    echo'not edit';
}
